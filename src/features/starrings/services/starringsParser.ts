...
// ============================================
// Starrings Parser - pure HTML -> StarringsResult
// ============================================
//
// Deliberately free of runtime imports (the type import above is erased), so it
// can run unchanged both in the browser and in Node from
// `scripts/fetch-starrings.ts`, which builds the snapshot shipped with the site.
// Keeping one implementation means a snapshot can never disagree with a live
// parse of the same page.
